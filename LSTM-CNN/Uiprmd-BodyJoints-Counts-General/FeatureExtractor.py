...
video = 1
while(exists("Exercises/"+str(exercise)+"/videos/V"+str(video)+"/Keypoints.txt")):
    numLines = 0
    with open("Exercises/"+str(exercise)+"/videos/V"+str(video)+"/Keypoints.txt", "r") as k:
        numLines = len(k.readlines())
    if numLines == 0:
        if not exists("Exercises/"+str(exercise)+"/videos/V"+str(video)+"/Features.txt"):
            with open("Exercises/"+str(exercise)+"/videos/V"+str(video)+"/Features.txt", "w"):
                pass
    else:
        with open("Exercises/"+str(exercise)+"/videos/V"+str(video)+"/Keypoints.txt", "r") as k:
