...
y_data = torch.from_numpy(xy[:, [2]].astype(np.float32)) #Tensor of corresponding total repCount values
...
print("\nTensor containing the corresponding total repCount values:")
print(y_data)
torch.save(y_data, "Exercises/"+str(exercise)+"/repCounts.pt")
