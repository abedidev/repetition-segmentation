...
def main():
    ...
    test_loop(model=my_model,test_dataset= dataset,inference= True,batch_size=1,lastckpt='checkpoint/ours/20_0.0009.pt', visualise=False, save_name='agnostic_raw_results')
