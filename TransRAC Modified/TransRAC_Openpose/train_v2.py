...
from train_looping_v3 import train_loop
...
train_dataset = OpenposeBodyJointsDataset(root_dir='',exercise_dir='openpose_data/',labels_dir='Annotations',
...
train_loop(NUM_EPOCHS, my_model, train_dataset, valid_set=None, train=True, valid=False,
           batch_size=BATCH_SIZE, lr=LR, saveckpt=True, ckpt_name='ours', log_dir='ours',
           lastckpt=lastckpt, mae_error=False)