...
def main():
    ...
    test_loop(model=my_model,test_dataset= dataset,inference= True,batch_size=1,lastckpt='checkpoint/ours/baseline_eph30.pt', visualise=False, save_name='agnostic_raw_results')
